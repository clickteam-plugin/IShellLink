...
BOOL CALLBACK DLLExport setupProc(
    HWND hDlg,
    uint msgType,
    WPARAM wParam,
    LPARAM lParam );
...
//
void WINAPI	DLLExport GetObjInfos(
    mv _far *mV,
    LPEDATA edPtr,
    LPSTR ObjName,
    LPSTR ObjAuthor,
...
int WINAPI DLLExport CreateObject(
    mv _far *mV,
    fpLevObj loPtr,
    LPEDATA edPtr )
{
...
//
void WINAPI	DLLExport PutObject(
    mv _far *mV,
    fpLevObj loPtr,
    LPEDATA edPtr,
    ushort cpt )
...
//
void WINAPI	DLLExport RemoveObject(
    mv _far *mV,
    fpLevObj loPtr,
    LPEDATA edPtr,
    ushort cpt )
...
//
void WINAPI DLLExport DuplicateObject(
    mv __far *mV,
    fpObjInfo oiPtr,
    LPEDATA edPtr )
{
...
//
void WINAPI DLLExport GetObjectRect(
    mv _far *mV,
    RECT FAR *rc,
    fpLevObj loPtr,
    LPEDATA edPtr )
...
extern "C" BOOL WINAPI DLLExport IsTransparent(
    mv _far *mV,
    fpLevObj loPtr,
    LPEDATA edPtr,
    int dx,
...
// 
void WINAPI	DLLExport PrepareToWriteObject(
    mv _far *mV,
    LPEDATA edPtr,
    fpObjInfo adoi )
{
...
//
void WINAPI	DLLExport CreateFromFile(
    LPMV mV,
    LPSTR fileName,
    LPEDATA edPtr )
{
...
//
BOOL WINAPI DLLExport GetProperties(
    LPMV mV,
    LPEDATA edPtr,
    BOOL bMasterItem )
{
...
//
void WINAPI DLLExport ReleaseProperties(
    LPMV mV,
    LPEDATA edPtr,
    BOOL bMasterItem )
{
...
//
LPARAM WINAPI DLLExport GetPropCreateParam(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID )
{
...
//
void WINAPI DLLExport ReleasePropCreateParam(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID,
    LPARAM lParam )
...
//
LPVOID WINAPI DLLExport GetPropValue(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID )
{
...
//
BOOL WINAPI DLLExport GetPropCheck(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID )
{
...
//
void WINAPI DLLExport SetPropValue(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID,
    LPVOID lParam )
...
//
void WINAPI DLLExport SetPropCheck(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID,
    BOOL nCheck )
...
//
BOOL WINAPI DLLExport EditProp(
    LPMV mV,
    LPEDATA edPtr,
    UINT nPropID )
{
...
//
DWORD WINAPI DLLExport GetTextCaps(
    mv _far *mV,
    LPEDATA edPtr )
{
...
//
BOOL WINAPI DLLExport GetTextFont(
    mv _far *mV,
    LPEDATA edPtr,
    LPLOGFONT plf,
    LPSTR pStyle,
...
//
BOOL WINAPI DLLExport SetTextFont(
    mv _far *mV,
    LPEDATA edPtr,
    LPLOGFONT plf,
    LPCSTR pStyle )
...
//
COLORREF WINAPI DLLExport GetTextClr(
    mv _far *mV,
    LPEDATA edPtr )
{
	// Example
...
//
void WINAPI DLLExport SetTextClr(
    mv _far *mV,
    LPEDATA edPtr,
    COLORREF color )
{
...
//
DWORD WINAPI DLLExport GetTextAlignment(
    mv _far *mV,
    LPEDATA edPtr )
{
	DWORD dw = 0;
...
//
void WINAPI DLLExport SetTextAlignment(
    mv _far *mV,
    LPEDATA edPtr,
    DWORD dwAlignFlags )
{
...
// 
static LPEVENTINFOS2 GetEventInformations(
    LPEVENTINFOS2 eiPtr,
    short code )
{
...
//
HMENU WINAPI DLLExport GetConditionMenu(
    mv _far *mV,
    fpObjInfo oiPtr,
    LPEDATA edPtr )
{
...
HMENU WINAPI DLLExport GetActionMenu(
    mv _far *mV,
    fpObjInfo oiPtr,
    LPEDATA edPtr )
{
...
HMENU WINAPI DLLExport GetExpressionMenu(
    mv _far *mV,
    fpObjInfo oiPtr,
    LPEDATA edPtr )
{
...
void WINAPI DLLExport GetActionTitle(
    mv _far *mV,
    short code,
    short param,
    LPSTR strBuf,
...
void WINAPI DLLExport GetConditionTitle(
    mv _far *mV,
    short code,
    short param,
    LPSTR strBuf,
...
void WINAPI DLLExport GetExpressionTitle(
    mv _far *mV,
    short code,
    LPSTR strBuf,
    short maxLen )
{
	GetCodeTitle(
        (LPEVENTINFOS2) expressionsInfos,
        code,
        0,
        MN_EXPRESSIONS,
        strBuf,
...
short WINAPI DLLExport GetActionCodeFromMenu(
    mv _far *mV,
    short menuId )
{
#ifndef RUN_ONLY
...
short WINAPI DLLExport GetConditionCodeFromMenu(
    mv _far *mV,
    short menuId )
{
#ifndef RUN_ONLY
...
short WINAPI DLLExport GetExpressionCodeFromMenu(
    mv _far *mV,
    short menuId )
{
#ifndef RUN_ONLY
...
LPINFOEVENTSV2 WINAPI DLLExport GetActionInfos(
    mv _far *mV,
    short code )
{
#ifndef RUN_ONLY
	return &GetEventInformations(
        (LPEVENTINFOS2) actionsInfos,
        code )->infos;
#else
	return NULL;
...
LPINFOEVENTSV2 WINAPI DLLExport GetConditionInfos(
    mv _far *mV,
    short code )
{
#ifndef RUN_ONLY
...
LPINFOEVENTSV2 WINAPI DLLExport GetExpressionInfos(
    mv _far *mV,
    short code )
{
#ifndef RUN_ONLY
...
void WINAPI DLLExport GetActionString(
    mv _far *mV,
    short code,
    LPSTR strPtr,
    short maxLen )
...
void WINAPI DLLExport GetConditionString(
    mv _far *mV,
    short code,
    LPSTR strPtr,
    short maxLen )
...
void WINAPI DLLExport GetExpressionString(
    mv _far *mV,
    short code,
    LPSTR strPtr,
    short maxLen )
...
//
void WINAPI DLLExport GetExpressionParam(
    mv _far *mV,
    short code,
    short param,
    LPSTR strBuf,
    short maxLen )
{
	...
	// Finds event in array
	LPEVENTINFOS2 eiPtr = GetEventInformations(
        (LPEVENTINFOS2) expressionsInfos,
        code );
...
// Initialize the parameter.
//
void WINAPI GetParameterString(
    mv _far *mV,
    short code,
    paramExt* pExt,
    LPSTR pDest,
